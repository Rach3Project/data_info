# List of Pieces in the Rach3 Dataset

The following table lists the pieces in the dataset, the pianist performing each piece (Pianist 1 = P1, Pianist 2 = P2, Pianist 3 = P3, and Pianist 4 = P4), and whether a score (in MusicXML format) is available for the piece.
...
| Chopin, Frédéric          | Fantasie-Impromptu                                            |                                                    | P1        | Y            |
...
| Liszt, Franz              | Transcendental Études S. 139                                  | No. 4 Mazeppa                                            | P1        | Y            |
...
| Ponce, Manuel             | 20 Piezas Fáciles Para Piano                                  | 1. Canción de los tamales                             | P1        | Y            |
...
| Rachmaninoff, Sergei      | Piano Concerto No. 3 Op. 30                                   | Third Movement                                        | P1        | Y            |
